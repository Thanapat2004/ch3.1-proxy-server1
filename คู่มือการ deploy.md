...
4.  **วิธีการตรวจสอบข้อมูลที่บันทึกเข้าไป**:
    *   **วิธีที่ 1 (ผ่าน Dashboard)**: เข้าเว็บ Supabase > เมนู **Table Editor** > เลือกตาราง `tasks` จะเห็นข้อมูลที่เพิ่ง Seed เข้าไป
...
## 🚩 ขั้นตอนที่ 3: เตรียม Backend ขึ้นระบบ (Render)
1.  **การสมัครสมาชิกรวมถึง Login**:
    *   เข้าหน้าเว็บ [Render.com](https://render.com/) และเลือก **Sign up with GitHub**
...
## 🚩 ขั้นตอนที่ 4: เตรียม Frontend ขึ้นระบบ (Netlify)
1.  **การสมัครสมาชิกรวมถึง Login**:
    *   เข้าหน้าเว็บ [Netlify.com](https://www.netlify.com/) และเลือก **Login with GitHub**
